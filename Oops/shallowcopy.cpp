...
// {
//     int a; // Step 4: Declare a private integer member variable 'a'
...
//     public:
//     one(one &obj) // Step 8: Define a copy constructor that takes a reference to an object of the same class (shallow copy)
//     {
